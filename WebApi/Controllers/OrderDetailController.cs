    ...
    public class OrderDetailController : ApiController
    {
        ...
        public string Post([FromBody]object value)
        {
            ...
            try
            {
                if (value != null)
                {
                   var orderdetail = JsonConvert.DeserializeObject<OrderDetail>(value.ToString());
                    result.Success = service.Insert(orderdetail);
                    return JsonConvert.SerializeObject(result);
                }
            }
            catch (Exception e)
        ...
        public string Put(int id, [FromBody]object value)
        {
            ...
            try
            {
                if (value != null)
                {
                    var orderdetail = JsonConvert.DeserializeObject<OrderDetail>(value.ToString().Trim());
                    orderdetail.OrderId = id;
                    result.Success = service.Update(orderdetail);
                    return JsonConvert.SerializeObject(result);
                }
